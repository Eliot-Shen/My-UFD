...
class CLIP(nn.Module):
    ...
    def encode_image(self, image, layernum):
        if layernum == "final":
            return self.visual(image.type(self.dtype))['after_projection']
        return self.visual(image.type(self.dtype))['layer'+layernum]
