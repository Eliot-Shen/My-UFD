...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--class_bal', default=None) 
        parser.add_argument('--batch_size', type=int, default=256, help='input batch size')
        parser.add_argument('--loadSize', type=int, default=336, help='scale images to this size') # 224
        ...
        parser.add_argument('--no_flip', default=False, type=bool, help='if specified, do not flip the images for data augmentation')
        parser.add_argument('--init_type', type=str, default='normal', help='network initialization [normal|xavier|kaiming|orthogonal]')
        parser.add_argument('--init_gain', type=float, default=0.02, help='scaling factor for normal, xavier and orthogonal.')
        parser.add_argument('--suffix', default='', type=str, help='customized suffix: opt.name = opt.name + suffix: e.g., {model}_{netG}_size{loadSize}')

        parser.add_argument('--no_crop', default=True, type=bool, help='if specified, do not flip the images for data augmentation')
        # parser.add_argument('--isTrain', default=False, type=bool, help='is Train or val now')
    ...
    def print_options(self, opt):
        ...
        print(f"Directory {expr_dir} is created.")
