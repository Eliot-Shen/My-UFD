...
def validate(model, loader, find_thres=False):
    with torch.no_grad():
        ...
        for img, label in loader:
            ...
            y_pred.extend(model(in_tens, evaling=True).sigmoid().flatten().tolist())
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_mode', type=str, default='ours', help='wang2020 or ours')
    ...
    parser.add_argument('--GaussianNoise', type=bool, default=False)  
